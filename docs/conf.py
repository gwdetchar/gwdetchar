# -*- coding: utf-8 -*-
#
# GWDetChar documentation build configuration file, created by
...
project = u'GWDetChar'
copyright = u'2015, The LIGO Scientific Collaboration and The Virgo Collaboration'
...
htmlhelp_basename = 'GWDetChardoc'
