...
<link href="https://fonts.googleapis.com/css?family=Roboto:300,500%7CRoboto+Mono" rel="stylesheet" type="text/css" media="all" />
...
def test_finalize_static_urls(tmpdir):
    ...
    assert css == [
        ...
        'https://fonts.googleapis.com/css?'
	        'family=Roboto:300,500%7CRoboto+Mono',  # nopep8
